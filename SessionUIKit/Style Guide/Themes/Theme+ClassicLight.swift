...
internal enum Theme_ClassicLight: ThemeColors {
    static let theme: [ThemeValue: UIColor] = [
        ...
        .sessionButton_background: .classicLight6,
        .sessionButton_highlight: .classicLight6.withAlphaComponent(0.3),
        .sessionButton_border: .classicLight2,
        .sessionButton_filledText: .classicLight0,
        .sessionButton_filledBackground: .classicLight6,
        .sessionButton_filledHighlight: .classicLight3,
        ...
        .sessionButton_primaryFilledBackground: .classicLight6,
    ...
    static let themeSwiftUI: [ThemeValue: Color] = [
        ...
        .sessionButton_text: .primary,
        .sessionButton_background: .classicLight6,
        .sessionButton_highlight: .classicLight6.opacity(0.3),
        .sessionButton_border: .classicLight2,
        .sessionButton_filledText: .classicLight0,
        .sessionButton_filledBackground: .classicLight6,
        .sessionButton_filledHighlight: .classicLight3,
